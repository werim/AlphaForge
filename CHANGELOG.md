...
### Added
- Frozen profitable LONG/SHORT, losing LONG, ambiguous TP+SL, execution-gate, correlated-portfolio and incomplete-geometry PAPER replays across decision, persistence, resolver, readiness and isolated audit, each repeated for deterministic semantics; real SIGKILL cold-start replay protection.
### Changed
...
### Known Issues
- Twelve of 23 golden cases run the production full chain. P2-E load and P1-E release qualification remain; LIVE NOT READY.
