...
gate, P2-C has seeded safety properties, and P2-D now replays fourteen golden cases
...
incomplete-geometry and resolved correct/false-reject cases have deterministic
production-chain replay, while the other scenarios remain P2-D work.
