...
gate, P2-C has seeded safety properties, and P2-D now replays fifteen golden cases
...
incomplete-geometry, resolved correct/false-reject and delayed-open-position cases
have deterministic production-chain replay, while the other scenarios remain P2-D work.
