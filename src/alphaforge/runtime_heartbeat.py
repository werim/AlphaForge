...
def _safe_payload(payload: Mapping[str, Any] | None) -> str:
    permitted = {
        ...
        "mtf_stale_context",
        "mtf_guided_candidates_generated",
        "mtf_legacy_candidates_shadowed",
        "mtf_setup_continuation",
        "mtf_setup_pullback",
        "mtf_setup_reentry_ready",
        "mtf_setup_no_setup",
        "mtf_setup_overextended",
        "mtf_setup_invalid",
        "equal_execution_candles_skipped",
        "replayed_execution_candles_skipped",
        "malformed_execution_candles_skipped",
        "finalized_signal_replays_skipped",
        "final_decision_lookup_failures",
