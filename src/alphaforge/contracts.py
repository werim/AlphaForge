...
class RejectReason(str, Enum):
    ...
    MTF_GUIDED_SETUP_SIDE_MISMATCH = "MTF_GUIDED_SETUP_SIDE_MISMATCH"
    MTF_GUIDED_GEOMETRY_UNAVAILABLE = "MTF_GUIDED_GEOMETRY_UNAVAILABLE"
    MTF_STATE_NO_TRADE = "MTF_STATE_NO_TRADE"
    MTF_STATE_GEOMETRY_UNAVAILABLE = "MTF_STATE_GEOMETRY_UNAVAILABLE"
    UNKNOWN = "UNKNOWN"
