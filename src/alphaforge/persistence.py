...
def init_db(database_url: str | None = None) -> Engine:
    ...
    ddl = [
        ...
        *_timesfm_forecast_evidence_ddl(),
        ...
        "CREATE TABLE IF NOT EXISTS release_gate_snapshots (id INTEGER PRIMARY KEY AUTOINCREMENT, snapshot_id TEXT NOT NULL UNIQUE, recorded_at TEXT NOT NULL, phase TEXT NOT NULL, status TEXT NOT NULL, ready INTEGER NOT NULL, blocking_reasons TEXT NOT NULL, evidence_payload TEXT NOT NULL)",
        "CREATE TABLE IF NOT EXISTS release_operator_acks (id INTEGER PRIMARY KEY AUTOINCREMENT, ack_id TEXT NOT NULL UNIQUE, recorded_at TEXT NOT NULL, operator_id TEXT, phase TEXT NOT NULL, valid_until TEXT, acknowledged INTEGER NOT NULL, evidence_payload TEXT NOT NULL)",
        "CREATE TABLE IF NOT EXISTS canary_mutation_attempts (id INTEGER PRIMARY KEY AUTOINCREMENT, attempt_id TEXT NOT NULL UNIQUE, recorded_at TEXT NOT NULL, mutation_type TEXT NOT NULL, blocked INTEGER NOT NULL, evidence_payload TEXT NOT NULL)",
    ]
