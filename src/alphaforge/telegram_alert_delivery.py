...
class TelegramAlertDeliveryEvidenceProvider:
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        try:
            ...
            return self._incomplete(f"TELEGRAM_DELIVERY_EXCEPTION:{exc.__class__.__name__}", probe_id=probe_id)
        ...
        if not accepted:
            return self._incomplete("TELEGRAM_SEND_NOT_CONFIRMED", probe_id=probe_id)
        return {
    ...
    @staticmethod
    def _incomplete(reason: str, *, probe_id: str | None = None, configured: bool = True) -> dict[str, Any]:
