...
CONFIG_REGISTRY: tuple[ConfigSetting, ...] = (
    ...
    _s("ALPHAFORGE_REGIME_DIRECTION_THRESHOLD", "regime_direction_threshold", "float", 0.0005, "Learning", ("PAPER",), "Regime-layer normalized MA delta required for direction.", 0.0),
    _s("ALPHAFORGE_SETUP_DIRECTION_THRESHOLD", "setup_direction_threshold", "float", 0.0005, "Learning", ("PAPER",), "Setup-layer normalized MA delta required for direction.", 0.0),
    _s("ALPHAFORGE_EXECUTION_DIRECTION_THRESHOLD", "execution_direction_threshold", "float", 0.0005, "Learning", ("PAPER",), "Execution-layer normalized MA delta required for confirmation.", 0.0),
