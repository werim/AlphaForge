...
CONFIG_REGISTRY: tuple[ConfigSetting, ...] = (
    ...
    _s("ALPHAFORGE_SETUP_DIRECTION_THRESHOLD", "setup_direction_threshold", "float", 0.0005, "Learning", ("PAPER",), "Setup-layer normalized MA delta required for direction.", 0.0, consumed_by="alphaforge.multi_timeframe.BinanceMTFProvider.build", behavioral_test="tests/test_reject_calibration_canonical.py::test_layer_thresholds_are_independent_and_identity_sensitive"),
