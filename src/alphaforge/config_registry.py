...
CONFIG_REGISTRY: tuple[ConfigSetting, ...] = (
    ...
    _s("ALPHAFORGE_PAPER_DECISION_TIMEFRAME", "paper_decision_timeframe", "str", "1m", "Learning", ("PAPER",), "Canonical PAPER scanner/geometry setup timeframe propagated to reject-forward evaluation evidence.", consumed_by="alphaforge.exchange_market_scanner._scan_binance", behavioral_test="tests/test_env_wiring_contract.py::test_paper_decision_timeframe_controls_scanner_and_reject_evidence"),
