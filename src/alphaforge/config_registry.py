...
CONFIG_REGISTRY: tuple[ConfigSetting, ...] = (
    ...
    _s("ALPHAFORGE_BINANCE_RECV_WINDOW_MS", "binance_recv_window_ms", "int", 5000, "Binance", ("PAPER", "LIVE"), "Signed request receive window.", 1, 60000, dashboard_editable=False, deprecated_aliases=("BINANCE_RECV_WINDOW_MS",), consumed_by="alphaforge.config.load_reconciliation_settings"),
    _s("ALPHAFORGE_RECONCILIATION_POSITION_EPSILON", "reconciliation_position_epsilon", "float", 0.00000001, "Operations", ("PAPER", "LIVE"), "Exact position quantity tolerance.", 0.0),
    _s("ALPHAFORGE_RECONCILIATION_MAX_FILL_SYMBOLS", "reconciliation_max_fill_symbols", "int", 50, "Operations", ("PAPER", "LIVE"), "Hard cap on symbols queried for fills.", 1, 1000),
