...
CONFIG_REGISTRY: tuple[ConfigSetting, ...] = (
    ...
    _s("ALPHAFORGE_RECONCILIATION_TIMEOUT_SEC", "reconciliation_timeout_sec", "float", 2.0, "Runtime Reconciliation", ("PAPER", "LIVE"), "Per-request timeout for exchange reconciliation.", 0.1, 60.0),
