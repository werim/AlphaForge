...
CONFIG_REGISTRY: tuple[ConfigSetting, ...] = (
    ...
    _s("ALPHAFORGE_PAPER_DECISION_TIMEFRAME", "paper_decision_timeframe", "str", "1m", "Learning", ("PAPER",), "Canonical PAPER setup and reject-forward evaluation candle timeframe."),
