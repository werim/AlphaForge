...
- Lifecycle coverage: no lifecycle semantics changed; populated near-miss and remaining diagnostics are now visible in rendered `/backtest/run` evidence
- Execution realism coverage: no execution model changes; near-miss and shadow diagnostics remain evidence-only
