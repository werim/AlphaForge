...
- Current version: Phase 9 burn-in identity parity hardening
...
- BACKTEST/PAPER/LIVE alignment: Phase 9 hashes one canonical Phase 8/9 identity payload for candidate creation and the constructed runtime; PAPER runtime limits remain mode-aware, while config drift fails closed.
