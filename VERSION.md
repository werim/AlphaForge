...
- **Audit addendum:** qualification startup no longer persists reconciliation probe findings into incident tables; forensic redaction expanded for nested secret-bearing keys/values.
- **Version:** `0.3.30-dev`
